...
VtkArray = []
timeList = range(2500, 50000, 2500)
for folder in folderList:
    fileList = []
    for time in timeList:
        basePath = '/home/archangel/Documents/EPFL/Computational Cell Biology/Project/stabilizeLipid4/{}dmpccs.lp4_eq_sim.con.{}.vtk'.format(folder, time)
